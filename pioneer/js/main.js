...
var locations = document.getElementById("location1").value;
...
sendEmail(name,email,phno,message,locations);
	  ...
	  function sendEmail(name,email,phno,message,locations) {
			Email.send({
				...
				To : 'anusweety256@gmail.com',
				From : "anusweety0424@gmail.com",
				Subject : "Query Info",
				Body :"Name :   "+name+"<html><br><br>Email : </html>"+email+"<html><br><br>Phone Number : </html>" +phno+
				"<html><br><br>Location : </html>"+locations+"<html><br><br>Required Services : </html>"+message+
				"<html><br><br><h4>Thank You Hr Insulations!</h4></html>"
				,
			})
